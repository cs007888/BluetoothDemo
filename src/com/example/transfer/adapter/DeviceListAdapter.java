...
import com.example.transfer.adapter.util.Device;
...
public class DeviceListAdapter extends BaseAdapter {
	...
	public DeviceListAdapter(Context context, List<BluetoothDevice> deviceList, int layoutId){
		...
		this.mLayoutInflater = LayoutInflater.from(context);//实例化一个layoutInflater
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(null == convertView){
			device = new Device();
			convertView = mLayoutInflater.inflate(mLayoutId, null);         //加载layOut布局
			device.mDeviceNameTV = (TextView) convertView.findViewById(R.id.deviceNameTV);//获取控件
			...
			convertView.setTag(device);                            // 绑定device
		}else {
