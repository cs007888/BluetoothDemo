...
import com.example.transfer.listener.DeviceListCCMenuListener;
import com.example.transfer.listener.SearchDeviceBtnClickListener;
import com.example.transfer.listener.SelectFileBtnClickListener;
import com.example.transfer.listener.SetVisibleBtnClickListener;
import com.example.transfer.receiver.PairStateChangeReceiver;
...
//修改
	...
	public void doSendFileByBluetooth() {
		...
		if (!filePath.equals("null")) {
			...
			boolean post = mOthHandler.post(new Runnable() {
